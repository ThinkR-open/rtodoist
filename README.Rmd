...
<!-- badges: start -->
[![R build status](https://github.com/VincentGuyader/todoist/workflows/R-CMD-check/badge.svg)](https://github.com/VincentGuyader/todoist/actions)
...
To find more details about the features, look at the 'How it works' article.
